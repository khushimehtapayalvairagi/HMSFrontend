...
const IPDAdmissionForm = () => {
 ...
 const [doctorName, setDoctorName] = useState(visit?.doctorName || '');
  ...
  const handleView = () => {
    ...
    navigate(`/receptionist-dashboard/IPDAdmissionList/${patientId}`, { state: { patientName } });
  };
  ...
  return (
    <div style={{ maxWidth: 600, margin: '2rem auto' }}>
      ...
      {!submitted ? (
        <form onSubmit={handleSubmit} style={{ padding: '2rem', border: '1px solid #ccc', borderRadius: 8 }}>
          <h2>IPD Admission</h2>
      ...
      .map((b) => (
        <option key={b._id} value={b.bedNumber}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: 15 }}>
            <button type="submit" style={{ flex: 1, backgroundColor: '#1976d2', color: 'white' }}>
              Admit
            </button>
            <button
              type="button"
        ...
        <div style={{ textAlign: 'center', padding: '2rem', border: '1px solid #28a745', borderRadius: 8 }}>
          ...
          <div ref={printRef} style={{ position: 'absolute', left: '-9999px', top: 0 }}>
            ...
            <div className="form-title">Admission Form</div>
            ...
            <div className="field-row">
              <div className="field">
                <label>Class:</label>
                <span>{roomCategories.find((c) => c._id === roomCategoryId)?.name || ''}</span>
              </div>
              <div className="field">
                <label>Doctor:</label>
            ...
            <div className="section-heading">Patient Name Breakdown</div>
            <div className="field-row">
              <div className="field">
                <label>SURNAME:</label>
                <span>{patientNameParts.surname}</span>
              </div>
              <div className="field">
                <label>FIRST NAME:</label>
                <span>{patientNameParts.firstName}</span>
              </div>
              <div className="field">
                <label>MIDDLE NAME:</label>
                <span>{patientNameParts.middleName}</span>
              </div>
            </div>

            <div className="consent">
              Consent: I have been explained the needs, nature, complications & consequences of
              admission/surgery in a language understood by me. I hereby give my consent for
